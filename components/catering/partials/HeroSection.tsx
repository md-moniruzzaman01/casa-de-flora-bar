...
const HeroSection = () => {
  ...
  return (
    <section className="relative h-screen min-h-[720px] flex items-end px-8 md:px-16 pb-20 overflow-hidden">
      ...
      {/* Hero Content */}
      <div className="relative z-30 w-full max-w-7xl mx-auto flex flex-col items-start gap-5 md:gap-10">

        {/* Tag: Specific outline pill styling */}
        <div className="border border-white/20 rounded-full px-5 py-1 md:py-2.5">
        ...
        <h1 className="font-serif text-[clamp(48px,8vw,110px)] leading-[1.05] tracking-[-0.01em] text-white">
          ...
          <span className="italic font-light text-[#f0cfd8]">{hero.titleAccent}</span>{" "}
          as the<br /> Flowers
        </h1>
        ...
        <div className="flex items-center gap-6 pt-2">
          ...
          <a
            ...
            className="bg-primary text-white text-[12px] font-bold tracking-[0.2em] uppercase px-12 py-2 md:py-5  hover:bg-white hover:text-[#1a1014] transition-all"
          >
            {hero.primary.label}
          </a>
          ...
          <a
            ...
            className="text-white text-[12px] font-semibold tracking-[0.2em] uppercase px-12 py-2 md:py-5  border border-white/30 hover:bg-white/10 transition-all"
          >
