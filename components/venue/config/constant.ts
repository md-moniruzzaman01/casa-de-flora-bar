export const VANUE_CONTENT = {
  booking_section: {
    ...
    headline_line_2: "your event",
    description:
      "Tell us about your vision and we'll get back to you within 24 hours to discuss availability, packages, and everything in between.",
    contact: {
  ...
  packages_section: {
    ...
    headline_line_1: "Choose your",
    headline_line_2: "perfect package",
    packages: [
      {
        id: "intimate",
        tag: "Up to 40 Guests",
