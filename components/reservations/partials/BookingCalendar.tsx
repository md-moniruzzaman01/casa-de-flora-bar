  ...
  return (
    <section className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm space-y-5">
      ...
      <div className="flex items-center justify-between mb-1">
        <div>
          <p className="text-[10px] font-sans uppercase tracking-[0.25em] text-[#c9a96e] mb-0.5">
            Step 1
          </p>
          <span className="font-serif text-xl font-normal text-gray-900">
      ...
      {/* Quick select */}
      <div>
        <p className="text-[11px] font-medium uppercase tracking-widest text-gray-400 mb-2 font-sans">
          Quick select
        </p>
        <div className="flex flex-wrap gap-2">
          {QUICK_OPTIONS.map(opt => (
            <button
              ...
              className={[
                "text-xs px-3 py-1.5 rounded-full border transition-colors font-sans",
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <h3 className="font-serif text-lg font-normal text-gray-900">
                  {selectedDayLabel}
                </h3>
              </div>
            </div>
            ...
            {slotsForDay.length === 0 && (
              <p className="text-sm text-gray-400 font-sans">No slots available for this date.</p>
            )}
      ...
      {selectedDate && (
        <div className="flex items-center justify-between bg-pink-50 border border-pink-100 rounded-xl px-4 py-3">
          <div>
            ...
            <p className="text-[11px] text-pink-600 mt-0.5 font-sans">
              {selectedSlot
          ...
          <button
            ...
            className="text-[11px] text-pink-500 underline hover:text-pink-700 transition-colors font-sans"
          >
            Clear
          </button>
        </div>
